...
contract Tests is Test {
  ...
  // ===========================
  // === decimals() function ===
  function test_decimals_1() public view {
  ...
  // =======================
  // === name() function ===
  function test_name_1() public view {
  ...
  // =========================
  // === symbol() function ===
  function test_symbol_1() public view {
  ...
  function test_totalSupply_1() public view {
  ...
  // ====================
  // === balanceOf() ====
  function test_balanceOf_1() public view {
