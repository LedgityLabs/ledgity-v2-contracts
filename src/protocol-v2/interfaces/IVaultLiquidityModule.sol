...
interface IVaultLiquidityModule {
    ...
    function accountWithdrawalFee(address account) external view returns (uint256);

    function totalAssets() external view returns (uint256 currentTotalAssets);
    ...
    function setCustomWithdrawalFee(address account, uint256 withdrawalFee) external;
